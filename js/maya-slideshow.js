/**
 * Dynamic Maya Glyph Slideshow
 * Interactive slideshow cycling through 25 glyphs with randomized PrettyColors backgrounds.
 */
...
(function () {
    const GLYPHS = [
        {
                "id": "T100",
                "file": "bauhaus_glyph_000100.svg"
        },
        {
                "id": "T101",
                "file": "bauhaus_glyph_000101.svg"
        },
        {
                "id": "T200",
                "file": "bauhaus_glyph_000200.svg"
        },
        {
                "id": "T300",
                "file": "bauhaus_glyph_000300.svg"
        },
        {
                "id": "T301",
                "file": "bauhaus_glyph_000301.svg"
        },
        {
                "id": "T302",
                "file": "bauhaus_glyph_000302.svg"
        },
        {
                "id": "T400",
                "file": "bauhaus_glyph_000400.svg"
        },
        {
                "id": "T500",
                "file": "bauhaus_glyph_000500.svg"
        },
        {
                "id": "T600",
                "file": "bauhaus_glyph_000600.svg"
        },
        {
                "id": "T700",
                "file": "bauhaus_glyph_000700.svg"
        },
        {
                "id": "T800",
                "file": "bauhaus_glyph_000800.svg"
        },
        {
                "id": "T900",
                "file": "bauhaus_glyph_000900.svg"
        },
        {
                "id": "T1000",
                "file": "bauhaus_glyph_001000.svg"
        },
        {
                "id": "T1100",
                "file": "bauhaus_glyph_001100.svg"
        },
        {
                "id": "T1200",
                "file": "bauhaus_glyph_001200.svg"
        },
        {
                "id": "T1201",
                "file": "bauhaus_glyph_001201.svg"
        },
        {
                "id": "T1300",
                "file": "bauhaus_glyph_001300.svg"
        },
        {
                "id": "T1301",
                "file": "bauhaus_glyph_001301.svg"
        },
        {
                "id": "T1302",
                "file": "bauhaus_glyph_001302.svg"
        },
        {
                "id": "T1303",
                "file": "bauhaus_glyph_001303.svg"
        },
        {
                "id": "T1400",
                "file": "bauhaus_glyph_001400.svg"
        },
        {
                "id": "T1500",
                "file": "bauhaus_glyph_001500.svg"
        },
        {
                "id": "T1501",
                "file": "bauhaus_glyph_001501.svg"
        },
        {
                "id": "T1600",
                "file": "bauhaus_glyph_001600.svg"
        },
        {
                "id": "T1601",
                "file": "bauhaus_glyph_001601.svg"
        }
];
    ...
    class MayaSlideshow {
        constructor() {
            this.card = document.getElementById("maya-slideshow-card");
            this.img = document.getElementById("maya-slideshow-img");
            this.counter = document.getElementById("maya-slideshow-counter");
            this.colorTag = document.getElementById("maya-slideshow-color");
            this.prevBtn = document.getElementById("maya-slideshow-prev");
            this.nextBtn = document.getElementById("maya-slideshow-next");
            this.shuffleBtn = document.getElementById("maya-slideshow-shuffle");

            if (!this.card || !this.img) return;
        ...
        getRandomColor() {
            ...
            } while (c === this.currentColor && PRETTY_COLORS.length > 1);
            return c;
        }

        render(index, newColor = true) {
            this.currentIndex = (index + GLYPHS.length) % GLYPHS.length;
            const item = GLYPHS[this.currentIndex];

            if (newColor || !this.currentColor) {
                this.currentColor = this.getRandomColor();
            }

            // Fade animation on image
            this.img.style.opacity = "0";
            this.img.style.transform = "scale(0.96)";

            setTimeout(() => {
                this.img.src = "maya/references/svg/" + item.file;
                this.card.style.backgroundColor = this.currentColor;
                this.card.style.borderColor = "rgba(0,0,0,0.08)";

                if (this.counter) {
                    const num = String(this.currentIndex + 1).padStart(2, "0");
                    this.counter.textContent = `${num} / 25 • ${item.id}`;
                }
                if (this.colorTag) {
                    this.colorTag.textContent = this.currentColor;
                }
        ...
        next() {
            this.render(this.currentIndex + 1, true);
        }
        ...
        initEvents() {
            ...
            this.card.addEventListener("click", () => this.next());
    ...
    window.initMayaSlideshow = function () {
        const card = document.getElementById("maya-slideshow-card");
        if (!card) return;
        slideshowInstance = new MayaSlideshow();
    };
})();
